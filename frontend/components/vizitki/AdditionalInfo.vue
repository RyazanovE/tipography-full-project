      ...
      <div class="tabs-content">
        ...
        <div class="tab-panel" :class="{ 'tab-panel--active': activeTab === 1 }">
          <div class="tab-content">
            <UiList
              title="Как оформить заказ на срочную печать визиток?"
              :listItems="[
              ...
              воспользовавшись нашим телеграм-ботом.`,
                'Чтобы быстро узнать стоимость и сразу получить скидку 5%, воспользуйтесь онлайн-калькулятором. Бонус будет зачислен на ваш личный счёт.'
              ]"
            />
            <UiList
              title="Форматы и материалы для визиток"
              :listItems="[
                `Мы предлагаем популярные форматы визиток: 90×50 мм 85×55 мм 90×55 мм В качестве
              материалов для печати используются:`,
                'Мелованная бумага, Color Copy, Лён, Тач Пейпер, Крафт и другие. Типы бумаги: Матовая (300 г/м²) — для элегантных визиток. Глянцевая (300 г/м²) — для ярких и блестящих цветов. Color Copy — для насыщенных цветов. А для идеального внешнего вида визиток мы предлагаем:',
                'Ламинирование (одностороннее и двустороннее). Кругление углов для стильного и аккуратного вида. После печати вы можете забрать визитки в наших пунктах выдачи или заказать доставку через СДЭК или курьером в день заказа.'
              ]"
            />
            <UiList
              title="Почему выбирают нас?"
              :listItems="[
                'Срочная печать визиток. Широкий выбор форматов и материалов. Дополнительные услуги для улучшения визиток. Гибкие варианты доставки, включая срочную доставку в день заказа.'
              ]"
            />
          </div>
        </div>
